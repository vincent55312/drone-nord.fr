  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-6">
        {/* Carte Leaflet */}
        <div className="relative h-[400px] shadow-xl rounded-lg overflow-hidden border border-[var(--silver)]/30">
          {mapReady && (
            <MapComponent 
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-[var(--polynesian-blue)]/90 to-transparent text-white z-[40]">
        ...
        <div 
          className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 mt-6 sm:mt-8"
          itemScope 
        ...
        >
          ...
          {departments.map((dept) => (
            <div 
              key={dept.id}
              className="bg-[var(--antiflash-white)] p-2 sm:p-4 rounded-lg shadow-md border border-[var(--silver)]/30"
              itemScope 
            ...
            >
              ...
              <div className="flex items-center mb-1 sm:mb-3">
                ...
                ></div>
                <h3 
                  className="text-base sm:text-lg font-medium text-[var(--polynesian-blue)]"
                  itemProp="name"
                >
                  {dept.name}
                </h3>
              ...
              <div className="grid grid-cols-1 xs:grid-cols-2 gap-1 sm:gap-2 text-sm sm:text-base">
                {dept.mainCities.map((city) => (
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-3 h-3 sm:w-4 sm:h-4 text-[var(--pumpkin)] mr-1 sm:mr-2">
        ...
        <div className="mt-3 sm:mt-4 bg-[var(--antiflash-white)] p-3 sm:p-4 rounded-lg shadow-md border border-[var(--silver)]/30">
          <div className="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 sm:w-5 sm:h-5 text-[var(--pumpkin)] mr-2">
